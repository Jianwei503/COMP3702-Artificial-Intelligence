...
def main(arglist):
    ...
    while not fringe.empty():
        ...
        for move in action_set:
            child = Node()
            child.map = LaserTankMap(game_map.x_size, game_map.y_size, [r[:] for r in parent.map.grid_data],
                                     parent.map.player_x, parent.map.player_y, parent.map.player_heading)
    ...
    print("Nodes generated: {}\n"
          "Nodes left in fringe: {}\n"
          "Nodes explored: {}\n".format(nodes_generated, nodes_fringe, nodes_visited))
